...
namespace CityForge
{
    ...
    public class Setting : ModSetting
    {
        ...
        [SettingsUIHidden] public string PanelBgColor { get; set; } = "#121418";

        private bool _lastEnableAchievements = true;

        public Setting(IMod mod) : base(mod) { }

        public override void Apply()
        {
            bool achievementsChanged = EnableAchievements != _lastEnableAchievements;
            base.Apply();
            if (achievementsChanged)
            {
                _lastEnableAchievements = EnableAchievements;
                try { Game.SceneFlow.GameManager.instance?.localizationManager?.ReloadActiveLocale(); }
                catch { }
            }
        }
        ...
        public class LocaleEN : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "Keep achievements enabled"              },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "Re-enables achievements even when mods are active." },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "Upgrade All Buildings to Level" },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "All citizens have maximum education (Level 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "Appearance" },
                    { "CheatMod.LABEL[PanelColor]",    "Panel Color" },
                    { "CheatMod.ACTION[ColorReset]",   "Reset" },
                    { "CheatMod.TOOLTIP[Desc]",        "All-in-One Cheat Panel by Venatorax" },
                    };

                if (_s.EnableAchievements)

                {

                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge has achievements enabled.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "Achievements are enabled by CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "Achievements are enabled by CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "Achievements are enabled by CityForge.";
        ...
        public class LocaleDE : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "Erfolge aktiv halten"                           },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "Aktiviert Erfolge auch wenn Mods aktiv sind."    },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "Alle Geb\u00e4ude upgraden auf Stufe"    },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "Alle Bürger haben maximale Bildung (Stufe 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "Erscheinungsbild" },
                    { "CheatMod.LABEL[PanelColor]",    "Panel-Farbe" },
                    { "CheatMod.ACTION[ColorReset]",   "Zur\u00fccksetzen" },
                    { "CheatMod.TOOLTIP[Desc]",        "All-in-One Cheat-Panel von Venatorax" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge hat Erfolge aktiviert.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "Erfolge werden von CityForge aktiviert.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "Erfolge werden von CityForge aktiviert.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "Erfolge werden von CityForge aktiviert.";

                }
                else
                {
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "Erfolge durch Mods deaktiviert.";
                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "Erfolge sind deaktiviert, weil Mods verwendet werden.";
                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "Erfolge sind deaktiviert, weil Mods verwendet werden.";
                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "Erfolge sind deaktiviert, weil Mods verwendet werden.";
                }
        ...
        public class LocaleFR : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "Garder les succ\u00e8s actifs"                   },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "R\u00e9active les succ\u00e8s m\u00eame avec des mods." },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "Tout upgrader au niveau"                 },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "Tous les citoyens ont une éducation maximale (Niveau 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "Apparence" },
                    { "CheatMod.LABEL[PanelColor]",    "Couleur du panneau" },
                    { "CheatMod.ACTION[ColorReset]",   "R\u00e9initialiser" },
                    { "CheatMod.TOOLTIP[Desc]",        "Panneau de triche tout-en-un par Venatorax" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge a activé les succès.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "Les succès sont activés par CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "Les succès sont activés par CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "Les succès sont activés par CityForge.";
        ...
        public class LocaleES : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "Mantener logros activos"                         },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "Reactiva los logros aunque haya mods activos."    },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "Mejorar todo al nivel"               },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "Todos los ciudadanos tienen educación máxima (Nivel 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "Apariencia" },
                    { "CheatMod.LABEL[PanelColor]",    "Color del panel" },
                    { "CheatMod.ACTION[ColorReset]",   "Restablecer" },
                    { "CheatMod.TOOLTIP[Desc]",        "Panel de trucos todo-en-uno por Venatorax" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge tiene los logros activados.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "Los logros están activados por CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "Los logros están activados por CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "Los logros están activados por CityForge.";
        ...
        public class LocaleIT : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "Mantieni obiettivi attivi"                        },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "Riattiva gli obiettivi anche con mod attive."      },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "Tutto al livello"                    },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "Tutti i cittadini hanno istruzione massima (Livello 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "Aspetto" },
                    { "CheatMod.LABEL[PanelColor]",    "Colore del pannello" },
                    { "CheatMod.ACTION[ColorReset]",   "Ripristina" },
                    { "CheatMod.TOOLTIP[Desc]",        "Pannello trucchi tutto-in-uno di Venatorax" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge ha attivato i risultati.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "I risultati sono attivati da CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "I risultati sono attivati da CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "I risultati sono attivati da CityForge.";
        ...
        public class LocaleJA : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "\u5b9f\u7e3e\u3092\u6709\u52b9\u306b\u4fdd\u3064" },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "MOD\u304c\u6709\u52b9\u3067\u3082\u5b9f\u7e3e\u3092\u518d\u6709\u52b9\u5316\u3057\u307e\u3059\u3002" },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "\u5168\u3066\u3092Lv\u306b\u30a2\u30c3\u30d7\u30b0\u30ec\u30fc\u30c9"               },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "全市民が最高教育レベルです（レベル4）" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "\u5916\u89b3" },
                    { "CheatMod.LABEL[PanelColor]",    "\u30d1\u30cd\u30eb\u30ab\u30e9\u30fc" },
                    { "CheatMod.ACTION[ColorReset]",   "\u30ea\u30bb\u30c3\u30c8" },
                    { "CheatMod.TOOLTIP[Desc]",        "Venatorax\u306b\u3088\u308b\u30aa\u30fc\u30eb\u30a4\u30f3\u30ef\u30f3\u30fb\u30c1\u30fc\u30c8\u30d1\u30cd\u30eb" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForgeが実績を有効にしました。";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "CityForgeによって実績が有効になっています。";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "CityForgeによって実績が有効になっています。";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "CityForgeによって実績が有効になっています。";
        ...
        public class LocaleKO : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "\uc5c5\uc801 \ud65c\uc131\ud654 \uc720\uc9c0" },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "\ubaa8\ub4dc\uac00 \ud65c\uc131\ud654\ub418\uc5b4 \uc788\uc5b4\ub3c4 \uc5c5\uc801\uc744 \ub2e4\uc2dc \ud65c\uc131\ud654\ud569\ub2c8\ub2e4." },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "\uc804\uccb4 Lv\ub85c \uc5c5\uadf8\ub808\uc774\ub4dc"           },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "모든 시민이 최대 교육 수준입니다 (레벨 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "\uc678\uad00" },
                    { "CheatMod.LABEL[PanelColor]",    "\ud328\ub110 \uc0c9\uc0c1" },
                    { "CheatMod.ACTION[ColorReset]",   "\ucd08\uae30\ud654" },
                    { "CheatMod.TOOLTIP[Desc]",        "Venatorax\uc758 \uc62c\uc778\uc6d0 \uce58\ud2b8 \ud328\ub110" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge가 업적을 활성화했습니다.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "CityForge에 의해 업적이 활성화되었습니다.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "CityForge에 의해 업적이 활성화되었습니다.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "CityForge에 의해 업적이 활성화되었습니다.";
        ...
        public class LocalePL : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "Utrzymuj osi\u0105gni\u0119cia aktywne"           },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "Ponownie w\u0142\u0105cza osi\u0105gni\u0119cia nawet z modami." },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "Ulepsz wszystko do poziomu"          },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "Wszyscy obywatele mają maksymalną edukację (Poziom 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "Wygl\u0105d" },
                    { "CheatMod.LABEL[PanelColor]",    "Kolor panelu" },
                    { "CheatMod.ACTION[ColorReset]",   "Resetuj" },
                    { "CheatMod.TOOLTIP[Desc]",        "Panel wszystko-w-jednym autorstwa Venatorax" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge ma włączone osiągnięcia.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "Osiągnięcia są aktywowane przez CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "Osiągnięcia są aktywowane przez CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "Osiągnięcia są aktywowane przez CityForge.";
        ...
        public class LocalePT : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "Manter conquistas ativas"                         },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "Reativa conquistas mesmo com mods ativos."         },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "Melhorar tudo para n\u00edvel"      },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "Todos os cidadãos têm educação máxima (Nível 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "Apar\u00eancia" },
                    { "CheatMod.LABEL[PanelColor]",    "Cor do painel" },
                    { "CheatMod.ACTION[ColorReset]",   "Redefinir" },
                    { "CheatMod.TOOLTIP[Desc]",        "Painel de trapa\u00e7as tudo-em-um por Venatorax" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge tem conquistas ativadas.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "As conquistas estão ativadas pelo CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "As conquistas estão ativadas pelo CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "As conquistas estão ativadas pelo CityForge.";
        ...
        public class LocaleRU : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "\u0421\u043e\u0445\u0440\u0430\u043d\u044f\u0442\u044c \u0434\u043e\u0441\u0442\u0438\u0436\u0435\u043d\u0438\u044f \u0430\u043a\u0442\u0438\u0432\u043d\u044b\u043c\u0438" },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "\u041f\u043e\u0432\u0442\u043e\u0440\u043d\u043e \u0432\u043a\u043b\u044e\u0447\u0430\u0435\u0442 \u0434\u043e\u0441\u0442\u0438\u0436\u0435\u043d\u0438\u044f \u0434\u0430\u0436\u0435 \u0441 \u043c\u043e\u0434\u0430\u043c\u0438." },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "\u0423\u043b\u0443\u0447\u0448\u0438\u0442\u044c \u0432\u0441\u0451 \u0434\u043e \u0443\u0440\u043e\u0432\u043d\u044f"   },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "Все граждане имеют максимальное образование (Уровень 4)" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "\u0412\u043d\u0435\u0448\u043d\u0438\u0439 \u0432\u0438\u0434" },
                    { "CheatMod.LABEL[PanelColor]",    "\u0426\u0432\u0435\u0442 \u043f\u0430\u043d\u0435\u043b\u0438" },
                    { "CheatMod.ACTION[ColorReset]",   "\u0421\u0431\u0440\u043e\u0441" },
                    { "CheatMod.TOOLTIP[Desc]",        "\u0423\u043d\u0438\u0432\u0435\u0440\u0441\u0430\u043b\u044c\u043d\u0430\u044f \u043f\u0430\u043d\u0435\u043b\u044c \u0447\u0438\u0442\u043e\u0432 \u043e\u0442 Venatorax" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge активировал достижения.";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "Достижения активированы CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "Достижения активированы CityForge.";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "Достижения активированы CityForge.";
        ...
        public class LocaleZHHans : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "\u4fdd\u6301\u6210\u5c31\u542f\u7528" },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "\u5373\u4f7f\u6709\u6a21\u7ec4\u4e5f\u91cd\u65b0\u542f\u7528\u6210\u5c31\u3002" },
                    ...
                    { "CheatMod.ACTION[UpgradeAll]",        "\u5168\u90e8\u5347\u81f3Lv"           },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "所有市民拥有最高教育水平（4级）" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "\u5916\u89c2" },
                    { "CheatMod.LABEL[PanelColor]",    "\u9762\u677f\u989c\u8272" },
                    { "CheatMod.ACTION[ColorReset]",   "\u91cd\u7f6e" },
                    { "CheatMod.TOOLTIP[Desc]",        "Venatorax\u7684\u5168\u80fd\u4f5c\u5f0a\u9762\u677f" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge已启用成就。";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "CityForge已为您启用成就。";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "CityForge已为您启用成就。";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "CityForge已为您启用成就。";
        ...
        public class LocaleZHHant : IDictionarySource
        {
            ...
            public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> e, Dictionary<string, int> i)
            {
                var d = new Dictionary<string, string>
                    ...
                    { _s.GetOptionLabelLocaleID(nameof(EnableAchievements)), "\u4fdd\u6301\u6210\u5c31\u555f\u7528" },
                    { _s.GetOptionDescLocaleID(nameof(EnableAchievements)),  "\u5373\u4f7f\u6709\u6a21\u7d44\u4e5f\u91cd\u65b0\u555f\u7528\u6210\u5c31\u3002" },
                    { "CheatMod.SECTION[Money]",            "\u8cc7\u91d1"                     },
                    ...
                    { "CheatMod.INFO[MaxEducation]",      "所有市民擁有最高教育水準（4級）" },
                    ...
                    { "CheatMod.SECTION[Appearance]",  "\u5916\u89c0" },
                    { "CheatMod.LABEL[PanelColor]",    "\u9762\u677f\u984f\u8272" },
                    { "CheatMod.ACTION[ColorReset]",   "\u91cd\u7f6e" },
                    { "CheatMod.TOOLTIP[Desc]",        "Venatorax\u7684\u5168\u80fd\u4f5c\u5f0a\u9762\u677f" },
                    };
...

                {
                    ...
                    d["Progression.ACHIEVEMENT_TAB_STATUS[ModsDisabled]"] = "CityForge已啟用成就。";

                    d["Menu.ACHIEVEMENTS_WARNING_MODS"] = "CityForge已為您啟用成就。";

                    d["Menu.ACHIEVEMENTS_WARNING_GAME_OPTIONS"] = "CityForge已為您啟用成就。";

                    d["Menu.ACHIEVEMENTS_WARNING_PAST_OPTIONS"] = "CityForge已為您啟用成就。";
